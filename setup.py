...
setup(
    ...
    download_url = 'https://codeload.github.com/ShenggaoZhu/django-sortedone2many/zip/0.1',
    license='MIT',
    description=
        'Provide a one-to-many relation that also remembers the order of related objects.',
